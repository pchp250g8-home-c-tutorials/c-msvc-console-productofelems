ProductOfElems. C Tutorials. Microsoft Visual Studio IDE. Simple Input/Output. Algorithms. Console application. 
...
ProductOfElems. ИС Visual Studio. Занятия по C. Простой Ввод/Вывод. Алгоритмы. Массивы. Платформа Windows. Консольное приложение.
